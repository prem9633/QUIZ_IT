...
public class Set11activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
                ...
                if (position == list.size()) {
                    ...
                    if (score <= 2) {
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), Set11activity.class); //If User get 20% let him or her play again
                                startActivity(BG);
                            }
                        });
                        ...
                        try_again.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Intent BG = new Intent(getApplicationContext(), Set11activity.class); ///If User get 50% let him or her play again
                                startActivity(BG);
                            }
                        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if (menuItem.getItemId() == R.id.home) {
            ...
            startActivity(home);
            Set11activity.super.onBackPressed();
